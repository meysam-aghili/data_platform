...
import com.rhodry.connect.connectors.elasticsearch.elastic.ElasticIndexMonitorThread;
import com.rhodry.connect.connectors.elasticsearch.task.ElasticSourceTask;
...
public class RhodryElasticsearchSourceConnector extends SourceConnector {
   private static Logger logger = LoggerFactory.getLogger(RhodryElasticsearchSourceConnector.class);
