...
package com.rhodry.connect.connectors.elasticsearch;
...
public class ElasticSourceConnectorConfig extends AbstractConfig {
        ...
        private static final String INCREMENTING_FIELD_NAME_DOC = "The name of the strictly incrementing field to use to detect new records.";
        ...
        private static final String SECONDARY_INCREMENTING_FIELD_NAME_DOC = "In case the main incrementing field may have duplicates, this secondary field is used as a secondary sort field"
                        +
        ...
        private static final String TOPIC_PREFIX_DOC = "Prefix to prepend to index names to generate the name of the Kafka topic to publish data";
        ...
        public static final String DELAY_SECONDS_CONFIG = "delay.seconds";
        private static final String DELAY_SECONDS_DOC = "The delay to introduce to the upperbound of the query. "
                        + "Set to avoid missing records to due to internal Elasticsearch replica sync delays.";
        private static final String DELAY_SECONDS_DEFAULT = "-1";
        private static final String DELAY_SECONDS_DISPLAY = "Delay seconds.";
        ...
        private static void addDatabaseOptions(ConfigDef config) {
                ...
                config.define(
                                ...
                                Width.LONG,
                                ES_HOST_DISPLAY,
                                Collections.singletonList(INDEX_PREFIX_CONFIG)).define(
                                                ES_SCHEME_CONF,
                                                Type.STRING,
                                                ES_SCHEME_DEFAULT,
                                                Importance.MEDIUM,
