...
package com.rhodry.connect.connectors.elasticsearch.task;

import com.rhodry.connect.connectors.elasticsearch.ElasticSourceConnectorConfig;
import com.rhodry.connect.connectors.elasticsearch.Version;
import com.rhodry.connect.connectors.elasticsearch.elastic.CursorField;
import com.rhodry.connect.connectors.elasticsearch.elastic.ElasticConnection;
import com.rhodry.connect.connectors.elasticsearch.elastic.ElasticConnectionBuilder;
import com.rhodry.connect.connectors.elasticsearch.elastic.ElasticRepository;
...
import com.rhodry.connect.connectors.elasticsearch.filter.BlacklistFilter;
import com.rhodry.connect.connectors.elasticsearch.filter.DocumentFilter;
import com.rhodry.connect.connectors.elasticsearch.filter.JsonCastFilter;
import com.rhodry.connect.connectors.elasticsearch.filter.WhitelistFilter;
import com.rhodry.connect.connectors.elasticsearch.schema.*;
...
import static com.rhodry.connect.connectors.elasticsearch.elastic.ElasticJsonNaming.removeKeywordSuffix;
...
public class ElasticSourceTask extends SourceTask {
    ...
    private void initEsConnection() {
        ...
        int delayMs = Integer.parseInt(config.getString(ElasticSourceConnectorConfig.DELAY_SECONDS_CONFIG));
        ...
        elasticRepository.setDelay(delayMs);
    }
